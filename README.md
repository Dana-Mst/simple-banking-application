...
You are tasked with creating a simple banking application that will handle accounts for customers.  The target is functionality wise a MVP solution for handling the current account balance.  REST/JSON API that allows for the following:
